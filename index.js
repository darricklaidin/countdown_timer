function updateDates(daysLeft, hoursLeft, minutesLeft, secondsLeft) {  // Updates the html with new values
    if (daysLeft < 0) {
...
function countdown() {
    ...
    if (endDateString.length != 0 && endDate != "Invalid Date") {
        ...
        const totalSeconds = (endDate - currentDate) / 1000;  // Converts total milliseconds to seconds
        ...
        updateDates(daysLeft, hoursLeft, minutesLeft, secondsLeft)

    }
    else {  // If invalid date or empty
        document.getElementById("days").innerHTML = "00";
        document.getElementById("hours").innerHTML = "00";
        document.getElementById("minutes").innerHTML = "00";
        document.getElementById("seconds").innerHTML = "00";
